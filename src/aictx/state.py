...
REPO_TASKS_DIR = Path(REPO_ENGINE_DIR) / "tasks"
REPO_TASKS_ACTIVE_PATH = REPO_TASKS_DIR / "active.json"
REPO_TASK_THREADS_DIR = REPO_TASKS_DIR / "threads"
REPO_MAP_DIR = Path(REPO_ENGINE_DIR) / "repo_map"
REPO_MAP_CONFIG_PATH = REPO_MAP_DIR / "config.json"
REPO_MAP_MANIFEST_PATH = REPO_MAP_DIR / "manifest.json"
REPO_MAP_INDEX_PATH = REPO_MAP_DIR / "index.json"
