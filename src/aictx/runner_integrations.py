...
summary.append("When available, follow prepared.runtime_text_policy, prepared.startup_banner_policy, and finalized.agent_summary_policy; for final summaries, prefer structured render payloads, localize human-readable prose, and preserve exact facts, technical tokens, and the details link/path.")
