...
def _readme_artifact_lines() -> list[str]:
    ...
    marker = "The stable repo-local continuity artifact contract in `4.5.1` is:"
...
def test_pyproject_describes_continuity_runtime():
    ...
    assert payload["project"]["version"] == "4.5.1"
...
def test_readme_contract_section_mentions_current_runtime_and_repomap():
    ...
    assert "Current documented implementation: `4.5.1`" in text
