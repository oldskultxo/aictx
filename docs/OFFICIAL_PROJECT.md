---
title: "Official AICTX Project Identity"
description: "Canonical identity for the official AICTX website, GitHub repository, PyPI package, CLI, maintainer, and non-affiliation statement."
---
...
1. Install from the PyPI page at [pypi.org/project/aictx](https://pypi.org/project/aictx/).
2. Check that the package name and CLI are both `aictx`.
3. Use documentation from [https://aictx.org](https://aictx.org).
