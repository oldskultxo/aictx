---
title: "Claude Code Memory with AICTX"
description: "Use AICTX as repo-local Claude Code memory for work state, handoffs, failure memory, and operational continuity across coding sessions."
---
...
## Start using Claude Code memory
